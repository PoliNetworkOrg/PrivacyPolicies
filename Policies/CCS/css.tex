...
La presente informativa è allegata al modulo Microsoft Forms generato dall'associazione "PoliNetwork APS" per ottenere il consenso, da parte dei candidati coinvolti, a pubblicare, oltre al loro nome e cognome, la loro email di contatto e il testo della motivazione della loro candidatura.
\end{itemize}
...
\begin{enumerate}
	\item dati personali identificativi (nome, cognome, e-mail)
...
\begin{enumerate}
	\item pubblicazione dei dati trattati (\textit{nome, cognome, e-mail, testo motivazione candidatura}) sul sito dell'associazione "PoliNetwork APS";
