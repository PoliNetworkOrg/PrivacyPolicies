...
La presente informativa è allegata al modulo Microsoft Forms generato dall'associazione "PoliNetwork APS" per ottenere il consenso, da parte dei candidati coinvolti, a pubblicare, oltre al loro nome e cognome, una o più delle seguenti: \begin{itemize}
	\item la loro email di contatto.
	\item il testo della motivazione della loro candidatura.
	\item il loro contatto Telegram.
\end{itemize} 
\end{itemize}
...
Il Titolare del Trattamento tratta 
\begin{enumerate}
	\item dati personali identificativi (nome, cognome, e-mail, contatto Telegram)
	\item porzione di testo associata al candidato riguardo le sue motivazioni alla sua candidatura
\end{enumerate} 
 comunicati dall’interessato in occasione della compilazione del Form.

 \subsection*{Dati obbligatori}
 \begin{enumerate}
	\item Nome
	\item Cognome
	\item Testo motivazione candidatura
 \end{enumerate}

 \subsection*{Dati facoltativi}
 \begin{enumerate}
	\item E-mail
...
\begin{enumerate}
	\item pubblicazione dei dati trattati (\textit{nome, cognome, e-mail, testo motivazione candidatura, contatto Telegram}) sul sito dell'associazione "PoliNetwork APS";
